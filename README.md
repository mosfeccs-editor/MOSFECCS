...
<p>MAKEVERSION: the perl script makeversion.pl takes the development version of MOSFECCS MOSFECCS_v6_SVG_DEV_210424-1.html(source) and generates the production versions (compiled and uncompiled) as well as the testing application mostest.js (running under nodeJS).</p>
