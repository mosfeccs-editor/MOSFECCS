...
<p>MAKEVERSION: the perl script makeversion.pl takes the development version of MOSFECCS source code:<br 7> MOSFECCS_v6_SVG_DEV_210424-1.html and generates the production versions (compiled and uncompiled) as well as the testing application mostest.js (running under nodeJS).</p>
